...
export const products: Product[] = [
  {
    ...
    summary:
      "Baraja española reinterpretada para Envite, con dorsos inspirados en pintaderas, maretas, barrancos, mar y tela canaria. Tiene que leerse rápido en una mesa real.",
    audience: "Jugadores, familias, asociaciones, bares, colegios y organizadores de torneos.",
    plannedContents: [
      "40 cartas españolas con jerarquía visual clara.",
      "Dorso propio con identidad canaria, no genérico.",
      "Carta de ayuda con malillas, matadores, señas y tanteo.",
      "Estuche rígido pensado para llevarlo a casas, bares y romerías.",
    ],
    pending: [
      "Cerrar diseño final de cartas, dorso y estuche.",
      "Validar materiales, impresión y durabilidad.",
      "Comparar proveedores y tirada mínima.",
      "Definir coste, precio, embalaje y logística antes de abrir ventas.",
    ],
  },
  {
    ...
    summary:
      "El pack para abrir una mesa completa: baraja, tapete de tela canaria, marcador de millos y guía rápida. Un producto para jugar, regalar y enseñar.",
    audience: "Familias, colectivos culturales, locales, asociaciones y regalos de grupo.",
    plannedContents: [
      "Baraja Envite Canario.",
      "Tapete inspirado en la tela canaria de romería.",
      "Marcador de Millos para arrayar envites y manos.",
      "Guía breve para montar una partida y explicar el juego.",
    ],
    pending: [
      "Validar medidas y materiales del conjunto.",
      "Diseñar embalaje con protección para envíos.",
  ...
  },
  {
    ...
    summary:
      "Un mantel de juego con alma de guachinche: franjas de tela canaria, zonas discretas de baza y espacio para cartas, señas y tanteo.",
    audience: "Jugadores habituales, clubes, bares, asociaciones y torneos.",
    plannedContents: [
      "Superficie antideslizante y fácil de limpiar.",
      "Formato apto para mesas domésticas y bares.",
      "Patrón de tela canaria aplicado sin tapar las cartas.",
      "Sistema de plegado o enrollado por validar.",
    ],
    pending: [
      "Elegir formato y dimensiones.",
      "Probar legibilidad con partidas reales.",
      "Validar resistencia, limpieza y transporte.",
      "Definir embalaje y coste por unidad.",
    ],
  },
  {
    ...
    summary:
      "Material operativo para que una comisión de fiestas, bar o asociación pueda montar un torneo con cuadros, actas, mesas y resultados claros.",
    audience: "Ayuntamientos, comisiones de fiestas, asociaciones, bares y organizadores.",
    plannedContents: [
      "Plantillas de inscripción, cuadros y actas.",
      "Marcadores de mesa e identificadores de equipos.",
      "Carteles y señalética del torneo.",
      "Guía operativa para inscripción, rondas, resultados y cierre.",
    ],
    pending: [
  ...
  },
  {
    ...
    summary:
      "Un contador físico con correderas para arrayar envites y anotar manos, sin millos sueltos sobre la mesa ni cuentas de memoria.",
    audience: "Mesas domésticas, bares, asociaciones y organizadores de torneos populares.",
    plannedContents: [
      "Carril independiente para envites.",
      "Carril independiente para manos cerradas.",
      "Correderas de madera o metal con marcas tipo millo.",
      "Base estable para mesa, validada con partidas reales.",
    ],
    pending: [
